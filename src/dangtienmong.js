...
export function dangTienMong() {
  ...
  const ENEMY_BIO = {
    cuongDao: 'Cường đạo lục lâm, chiếm núi xưng vương. Đao thô mà sát khí đằng đằng, ra tay tàn nhẫn, giết người chỉ vì manh áo miếng cơm.',
    satThu: 'Sát thủ Hắc Phong, ẩn thân trong bóng tối. Sát khí ngưng nơi đầu ngón, xuất thủ tất lấy yết hầu; đoạt mệnh trong chớp mắt, chẳng lộ hình tung.',
    langYeu: 'Yêu lang sinh nơi mộng cảnh, thú tính hung hãn chưa khai linh trí. Vuốt sắc hổ gầm cắn xé, gặp nguy thu mình; chỉ biết cuồng bạo, chẳng rõ chiêu số.',
    taoKhau: 'Thảo khấu sơn dã, chiếm đường cướp của. Đao thô chém giết vặt vãnh, hữu dũng vô mưu; gặp ai cũng liều mạng vì manh áo miếng cơm.',
    daLang: 'Dã lang hoang dại, săn mồi theo bầy chẳng khi đơn độc. Bổ nhào vờn mồi, cắn xé liên hoàn; hợp quần vây khốn, lấy số áp người.',
    cungThu: 'Cung thủ lục lâm, nấp trong tán cây bắn lén từ xa. Ngưng thần ngắm bắn đoạt mạng chẳng ngơi; thủ đoạn ám muội, không dám giáp mặt.',
    tanKiem: 'Kiếm đồ lang bạt, không môn không phái, kiếm học lỏm tạp nham. Loạn chiêu mà liều đoạt mạng, hữu chiêu vô lý; chỉ mong một kiếm đổi miếng cơm.',
    doCo: 'Giáo đồ Ngũ Độc chốn Nam Cương, nuôi cổ thả độc mưu hại người. Điểm huyệt hạ độc, độc vụ mê hồn tỏa sương; âm hiểm khôn lường, gieo độc chẳng ghê tay.',
    luyenKhi: 'Tán nhân luyện khí nơi hoang cốc, cầu công quá gấp mà tẩu hỏa nhập ma. Hỏa chưởng liệt diễm bốc cháy cả thân, chân khí phản phệ; cuồng loạn thiêu người mà tự thiêu chính mình.',
    hoaSonKiem: 'Kiếm sĩ Hoa Sơn, một đời tôi luyện khí tông, lấy khí ngự kiếm. Kiếm ý ngưng như băng tuyết, xuất thủ nhẹ mà sắc thấu xương; một chiêu mai hoa điểm huyệt đoạt mệnh.',
    duongMon: 'Sứ giả Đường Môn ẩn trong bóng tối, mười ngón giấu mười phần chết chóc. Ám khí tẩm độc vừa rời tay đã lấy mạng, phòng chẳng kịp phòng.',
    caiBang: 'Trưởng lão Cái Bang, áo vải rách vai mà cốt cách hào sảng. Trúc bổng múa như rồng say, tưởng lảo đảo mà chiêu chiêu hiểm hóc; chân nhân bất lộ tướng, khiến địch khinh thường rồi chuốc bại.',
    ngaMiSu: 'Sư thái Nga Mi, một thân từ bi mà võ công chính trực nghiêm minh. Kiếm pháp công thủ vẹn toàn, tiến đoạt mệnh, lui hộ thân; nhu trung ngụ cương, chẳng cho địch hở một tấc.',
    thieuLam: 'Võ tăng Thiếu Lâm, kim thân bất hoại, một đời khổ luyện ngoại công cương mãnh. La Hán quyền phong hùng như sấm dậy, cương mãnh phá vạn pháp; một quyền dốc toàn lực, khiến người chẳng dám khinh nhờn.',
    voDang: 'Đạo cốt tiên phong, một đời Thái Cực. Dĩ tĩnh chế động, thuận thế mà hành; tứ lạng bạt thiên cân, nhu hóa vạn kình. Chỉ tiếc chấp niệm chưa dứt, còn vương một giấc mộng chưa thành.',
    thienSon: 'Lão tổ băng phong tuyết lĩnh, tu Ngưng Băng Hàn Khí. Chưởng phát hàn quang, phong bế kinh mạch; lạnh lùng tàn khốc, một hơi đóng băng vạn vật. Tâm ma khóa chặt, hàn niệm không tan giữa mộng.',
    nhatNguyet: 'Giáo chủ oai chấn một cõi, ma khí ngùn ngụt bức người. Kiếm âm hòa Tụ Ma vận công, chiêu ra thì thiên sầu địa ám. Chỉ tiếc bá nghiệp dở dang, oán khí còn vương nơi mộng.',
    bongLai: 'Tán tiên tiên phong đạo cốt, ngự kiếm đạp mây. Ngũ kiếm hợp thuật thu vạn khí quy nhất, ngọc lộ hồi xuân dưỡng thân bất lão. Tiên duyên tuy sẵn mà chấp niệm chưa buông, vẫn ôm một giấc mộng chưa thành.',
    maGiao: 'Hộ pháp Ma Giáo chết rồi oán chẳng tan. Ma công thâm hiểm hằn sâu trong mộng, gặp ai cũng chỉ biết sát phạt. Một niệm cuồng sát, mãi không siêu thoát.',
    lacVoTran: 'Nụ cười càng tươi, độc thủ càng thâm. Cẩm hương thoảng qua đã hoại cốt tan gân; kẻ trúng chiêu còn ngỡ gặp bậc phong lưu. Tàn niệm rơi vào mộng, tiếng cười âm u chẳng dứt.',
    doDuocMaCo: 'Nuôi vạn cổ độc chốn Nam Cương, lấy độc dưỡng thân, càng già càng âm hiểm. Gieo độc rồi hút ngược nguyên khí, tự dưỡng cầu sinh trăm năm bất lão. Oán niệm hóa mộng, ôm bình cổ độc chẳng buông.',
    namCungLietHoa: 'Nửa mặt hồng liên, nửa mặt tro tàn, cả đời vì lửa mà cuồng. Chưởng đi tới đâu thiêu rụi tới đó; điểm một mồi hỏa là bùng thành biển lửa. Tàn niệm cháy mãi trong mộng, không tro nào dập nổi.',
    khongTichThuyenSu: 'Tọa thiền trăm năm, thân như tường đồng vách sắt, tâm tựa giếng xưa. Càng đỡ càng vững, giáp dư phản kình thành sát chiêu. Chấp niệm bất động ngồi lì giữa mộng, một chưởng khai sơn nặng ngàn cân.',
    coNhanMaiKiem: 'Trồng mai luyện kiếm nơi cô sơn, một đời mài một chiêu Lạc Mai. Kiếm chưa rời vỏ đã định sinh tử; vận đủ kình rồi, một nhát điểm hoa rơi lấy mạng. Kiếm ý cô tịch vương trong mộng, chờ người đủ sức tiếp một chiêu.',
    vanVongNuong: 'Không tên không họ, thân pháp nhu như mây trôi nước chảy. Mượn lực đánh lực, gặp cương thì hóa; đòn nặng mấy cũng tan vào hư không rồi phản lại người. Dáng mây phiêu hốt lượn giữa mộng, khó nắm khó lường.',
    langToCam: 'Ôm cây dao cầm mười ba dây, mỗi dây một đường sát cơ. Tay khảy tơ đồng mà kình phát như mưa; mười ba tuyến đan nhau vây kín chẳng chừa đường lui. Khúc đoạn huyền dang dở còn ngân trong mộng, tơ đứt mà oán chưa tan.',
    toUyenNghiet: 'Độc nhãn nhìn đời bằng nửa con mắt, một đời chỉ luyện một thích: nhất kích đoạn mệnh. Ám khí xuyên giáp phá thuẫn, thấy máu là đoạt hồn; kẻ suy yếu chớ hòng thoát nhát cuối. Sát niệm lạnh lẽo ẩn trong mộng, chờ sơ hở để ra tay.',
    bangPhachNuHiep: 'Một thân băng phách lạnh thấu tâm can, chưởng đi tới là sương giá đóng băng kinh mạch. Hàn khí tích dần khóa chặt thân địch, tê liệt rồi mới giáng chưởng cuối. Băng hồn cô tịch phong bế giữa mộng, lạnh lùng mà kiêu bạc.',
  };
  ...
  return {
    ...
    devAddCard(where) { const id = this.devCardSel; if (!id || !POOL[id]) return; this._devRun(); if (where === 'hand') { if (this.phase !== 'battle') { this._devLog('phải đang trong trận để thêm vào tay'); return; } this.hand.push(mk(id)); } else { this.run.deck.push(mk(id)); } this._devLog((where === 'hand' ? '+tay: ' : '+bộ bài: ') + POOL[id].name); },
    ...
    openEvent() { this.event = rnd([
      ...
      { title: 'Cường Đạo Lạc Thảo', text: 'Bọn lục lâm chặn lối, đầu lĩnh cười nhạt: "Muốn qua thì để lại chút gì — bằng không đừng trách đao thương vô tình."',
        opts: [{ label: 'Nộp lộ phí (−25 Mộng Ngân, yên thân)', fn: () => { this.runNgan = Math.max(0, this.runNgan - 25); this.log = 'Bỏ chút bạc, yên thân qua ải.'; this.afterNode(); } },
                { label: 'Liều cướp lại (−8 HP, +35 Mộng Ngân)', fn: () => { this.run.hp = Math.max(1, this.run.hp - 8); this.runNgan += 35; this.log = 'Đoạt túi bạc trong tay giặc! +35 Mộng Ngân.'; this.afterNode(); } }] },
      { title: 'Quái Khách Luận Võ', text: 'Một kiếm khách áo trắng khoanh tay bên gốc tùng: "Mộng cảnh nhàn rỗi, dám cùng ta đấu một chiêu chăng?"',
      ...
      { title: 'Đan Lô Bỏ Hoang', text: 'Trong hang tối, một lò luyện đan còn ấm — viên đan chưa rõ dược tính nằm giữa lò, thoảng mùi kỳ lạ.',
