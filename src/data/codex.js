...
const SLOT_NAME = { mu: 'Mũ', giap: 'Áo', dai: 'Đai', gang: 'Găng', giay: 'Giày', vuKhi: 'Vũ Khí', nhan: 'Nhẫn', trangSuc: 'Trang Sức', toaKy: 'Tọa Kỵ', phiPhong: 'Phi Phong', riu: 'Rìu', cuoc: 'Cuốc', canCau: 'Cần Câu', duocLiem: 'Dược Liêm' };
