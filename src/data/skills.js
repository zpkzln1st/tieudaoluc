...
export const SKILLS = {
  ...
  dieuNgu: {
    ...
    actions: [
      { id: 'caTuyet', name: 'Tuyết Ngư', gloss: 'Cod',    itemId: 'caTuyet', zone: 'lamLinhCoc', reqLevel: 1,  xp: 3, time: 10.0, statXp: 1 },
      { id: 'caHoi',   name: 'Hồi Ngư',   gloss: 'Salmon', itemId: 'caHoi',   zone: 'uLam',       reqLevel: 8,  xp: 5, time: 13.0, statXp: 1 },
      { id: 'caTon',   name: 'Hương Ngư', gloss: 'Trout',  itemId: 'caTon',   zone: 'huyenDo',    reqLevel: 18, xp: 8, time: 16.0, statXp: 2 },
      { id: 'luNgu',   name: 'Lư Ngư',    gloss: 'Perch',  itemId: 'luNgu',   zone: 'huyenDo',    reqLevel: 18, xp: 9, time: 18.0, statXp: 2 },
      { id: 'tinhLanNgu', name: 'Tinh Lân Ngư', gloss: 'Crystalscale Fish', itemId: 'tinhLanNgu', zone: 'thuyTinhDong',  reqLevel: 32,  xp: 18,  time: 24.0, statXp: 4 },
      { id: 'bangLanNgu', name: 'Băng Lân Ngư', gloss: 'Frostscale Fish',   itemId: 'bangLanNgu', zone: 'langTieuPhong', reqLevel: 48,  xp: 30,  time: 30.0, statXp: 5 },
      { id: 'ocTuyenNgu', name: 'Ốc Tuyền Ngư', gloss: 'Oasis Fish',        itemId: 'ocTuyenNgu', zone: 'meAoLucChau',   reqLevel: 60,  xp: 44,  time: 38.0, statXp: 6 },
      { id: 'vanLyNgu',   name: 'Vân Lý Ngư',   gloss: 'Cloud Carp',        itemId: 'vanLyNgu',   zone: 'phuKhongVien',  reqLevel: 70,  xp: 60,  time: 46.0, statXp: 7 },
      { id: 'tinhDieuNgu',name: 'Tinh Diệu Ngư',gloss: 'Starlight Fish',    itemId: 'tinhDieuNgu',zone: 'quanTinhDai',   reqLevel: 78,  xp: 82,  time: 54.0, statXp: 8 },
      { id: 'haiGiaoNgu', name: 'Hải Giao Ngư', gloss: 'Sea Dragon Fish',   itemId: 'haiGiaoNgu', zone: 'tichNguDao',    reqLevel: 92,  xp: 120, time: 64.0, statXp: 9 },
      { id: 'thienTriNgu',name: 'Thiên Trì Ngư',gloss: 'Heavenly Koi',      itemId: 'thienTriNgu',zone: 'thienThanh',    reqLevel: 100, xp: 165, time: 75.0, statXp: 10 },
    ],
