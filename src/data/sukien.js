...
export const SU_KIEN_DS = [
  // ================= 1. TẾT =================
  {
    ...
    pet: { base: 'kimDongNgu', name: 'Kim Đồng Ngư', he: 'kim', emoji: '🐟', role: 'Chiêu Tài', tuTru: 'linhXao',
      ...
      loreTrung: 'Trứng ánh vảy vàng của Kim Đồng Ngư. Ấp nở sẽ sinh ra Linh Ngư mang điềm chiêu tài đón lộc.' },
  ...
  // ================= 2. MÙA XUÂN =================
  {
    ...
    pet: { base: 'thaiVuDiep', name: 'Thải Vũ Điệp', he: 'moc', emoji: '🦋', role: 'Nhanh Nhẹn', tuTru: 'thanPhap',
      ...
      loreTrung: 'Trứng lụa ánh ngũ sắc của Thải Vũ Điệp. Ấp nở sẽ sinh ra Linh Điệp với đôi cánh năm màu.' },
  ...
  // ================= 3. ĐOAN NGỌ =================
  {
    ...
    pet: { base: 'xichDiemLongCau', name: 'Xích Diễm Long Câu', he: 'hoa', emoji: '🐉', role: 'Bạo Phát', tuTru: 'lucDao',
      ...
      loreTrung: 'Trứng đỏ sẫm, trên vỏ có vân lửa của Xích Diễm Long Câu. Ấp nở sẽ sinh ra Long Câu bờm lửa.' },
  ...
  // ================= 4. VU LAN =================
  {
    ...
    pet: { base: 'uMinhMieu', name: 'U Minh Miêu', he: 'tho', emoji: '🐈‍⬛', role: 'Ẩn Nặc', tuTru: 'linhXao',
      ...
      loreTrung: 'Trứng đen tuyền của U Minh Miêu. Ấp nở sẽ sinh ra Linh Miêu bước đi không phát ra tiếng.' },
  ...
  // ================= 5. TRUNG THU =================
  {
    ...
    pet: { base: 'ngocTho', name: 'Ngọc Thố', he: 'thuy', emoji: '🐇', role: 'Cát Tường', tuTru: 'linhXao',
      ...
      loreTrung: 'Trứng trắng ngà ánh ngọc của Ngọc Thố. Ấp nở sẽ sinh ra Linh Thố của Quảng Hàn.' },
  ...
  // ================= 6. GIÁNG SINH =================
  {
    ...
    boss: [
      { id: 'yvBachGiacLocVuong', name: 'Bạch Giác Lộc Vương', icon: '🦌', affinity: 'Yêu Vương · Lộc Vương', lv: 10,
        lore: 'Tuần lộc gạc trắng dẫn đầu đàn, vó nhẹ đến mức bước trên tuyết cũng không để lại dấu.',
      ...
      { id: 'yvTuyetSonLaoNhan', name: 'Tuyết Sơn Lão Nhân', icon: '🎅', affinity: 'Yêu Vương · Tuyết Sơn', lv: 60,
        lore: 'Ông lão sống trong căn nhà gỗ cuối rừng. Mỗi năm đúng một đêm, ông gõ cửa từng nhà — nhưng chẳng ai nhớ nổi khuôn mặt ông.',
    ...
    biCanh: [
      ...
      { id: 'hanChungDien', name: 'Hàn Chung Điện', seal: '鐘', lv: 70, hazard: 'linhXao', hazardName: 'Chuông Đoạt Ký Ức',
        ...
        lore: 'Điện thờ treo ngàn chiếc chuông băng. Mỗi khi một chiếc ngân lên, ở đâu đó sẽ có một người quên mất một ký ức.' },
    ],
    ...
    pet: { base: 'bachLoc', name: 'Bạch Lộc', he: 'thuy', emoji: '🦌', role: 'Trợ Thủ', tuTru: 'hoThe',
      ...
      loreTrung: 'Trứng Bạch Lộc trắng như tuyết, phủ vân băng nhạt. Ấp nở sẽ sinh ra một linh lộc có gạc treo chuông.' },
...
// 2026-08-12: cả sáu sự kiện đã đủ 3 tệp (2 ảnh đại diện + 1 ảnh bìa) — đối chiếu bằng
// _mockup/_covua_wip/_soi_art_moi.mjs, mục B ra 29/29 cho cả sáu.
export const CO_ART_DUNG_MAO = new Set(['tet', 'xuan', 'doanNgo', 'vuLan', 'trungThu', 'giangSinh']);
