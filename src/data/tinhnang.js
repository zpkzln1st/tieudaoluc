...
export const TINH_NANG = [
  ...
  { ma: 'bangChien',    ten: 'Bang Phái Tranh Chấp',       dot: 'Năm thứ nhất', daDung: true,
  ...
  { ma: 'dauTruong',    ten: 'Đấu Trường',                 dot: 'Năm thứ hai',  daDung: true,
    mo: 'Đấu với bản chụp bộ chiến đấu của người khác, ăn Đấu Điểm.' },
