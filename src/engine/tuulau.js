...
const CAU_NGOI = [
  ...
  'Đao đặt dưới bàn, tay vẫn không rời chuôi.',
  'Quán đông thế này, chắc chắn có người đến không chỉ để uống rượu.',
  ...
  'Nghe nói tháng trước có người Phá Quan. Chưa biết là thật hay chỉ là lời đồn.',
  'Ngồi lâu quá, chân tê mà lòng chưa yên.',
  'Đêm nay trăng mỏng, rất hợp để lên đường xa.',
  'Ai trả tiền rượu thì người đó nói, quy củ ở đây là vậy.',
  'Ta từng thua một trận, nhớ tới giờ.',
];
const CAU_MOI = [
  'Chén này ta nhận. Có gì muốn hỏi thì cứ hỏi.',
  'Rượu ngon. Người mời rượu thường chẳng mời suông.',
  'Được, ngươi có lòng. Ta kể ngươi nghe một chuyện.',
  'Lâu rồi không ai mời ta. Ngồi xuống đi.',
  'Uống thì uống, nhưng đừng hỏi chuyện năm xưa.',
  'Chén đầy thì lời cũng đầy theo.',
  'Ngươi mời khéo lắm. Ta không thích mang nợ.',
  'Cạn chén. Giờ thì nghe cho kỹ.',
];
const CAU_HOI = [
  ...
  'Đừng học theo ta. Con đường ta đi sai nhiều hơn đúng.',
  'Muốn mạnh thì đừng vội. Vội vàng rất dễ mất mạng.',
  'Ta có một chiêu chưa từng dùng. Chỉ mong cả đời không cần dùng tới.',
  'Kẻ mạnh không phải kẻ thắng nhiều, là kẻ còn ngồi được ở đây.',
  'Hỏi vừa thôi. Có những chuyện biết quá nhiều lại thành họa.',
];
