...
'  position:relative; height:min(660px,calc(100vh - 200px)); min-height:440px; display:flex; flex-direction:column; gap:8px; color:var(--tx); font-size:14px; font-family:ui-sans-serif,system-ui,-apple-system,"Segoe UI",Roboto,sans-serif,"Noto Serif SC"; }',
...
'.ktb .fserif{ font-family:"Lora","Noto Serif SC",serif; font-weight:700; }',
...
'.ktb .fighter .fname{ font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:.86rem; margin-top:2px; line-height:1.28; }',
...
'.ktb .ktb-turn{ display:inline-flex; align-items:center; gap:6px; padding:4px 11px; border-radius:99px; font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:.76rem; border:1px solid var(--bd); background:var(--ink3); white-space:nowrap; flex:none; }',
...
'.ktb .ktb-extra{ display:none; align-items:center; gap:5px; padding:4px 11px; border-radius:99px; font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:.72rem; color:#3a2606; background:linear-gradient(180deg,#f7e2a8,#f5b942); box-shadow:0 0 14px -3px var(--gold); white-space:nowrap; }',
...
'.ktb .fnum{ position:absolute; transform:translate(-50%,-50%); font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:22px; text-shadow:0 2px 6px #000; animation:ktbFnum 1s ease forwards; white-space:nowrap; }',
...
'.ktb .combolabel{ position:absolute; top:8px; left:50%; transform:translateX(-50%); z-index:31; font-family:"Lora","Noto Serif SC",serif; font-weight:700; color:var(--gold); text-shadow:0 2px 8px #000; opacity:0; pointer-events:none; }',
...
'.ktb .skcue-nm{ position:absolute; left:50%; top:50%; transform:translate(-50%,-50%) scale(1.25); font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:clamp(1.05rem,4.6vw,1.8rem); color:#fff; text-shadow:0 0 16px var(--acc), 0 2px 7px #000; opacity:0; white-space:nowrap; }',
...
'.ktb .obox h1{ font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:1.5rem; color:var(--gold); margin:0 0 4px; }',
...
'.ktb .ores-main .ttl{ font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:1.42rem; color:var(--gold2); margin-top:3px; line-height:1.1; }',
'.ktb .ores.lose .ores-main .ttl{ color:var(--rose); }',
'.ktb .ores-main .sub{ color:var(--tx2); font-size:.8rem; margin-top:4px; font-style:italic; font-family:"Lora","Noto Serif SC",serif; }',
...
'.ktb .ores-loot b{ font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:1.05rem; color:var(--gold2); }',
...
'.ktb .ores-unlock{ font-family:"Lora","Noto Serif SC",serif; font-size:.7rem; font-weight:700; color:#3a2606; background:linear-gradient(180deg,#f7e2a8,#f5b942); border-radius:20px; padding:3px 11px; box-shadow:0 2px 8px -3px rgba(245,185,66,.5); }',
'.ktb .ores-acts{ display:flex; gap:9px; padding:15px 22px 20px; border-top:1px solid rgba(255,255,255,.05); }',
'.ktb .ores-btn{ flex:1; font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:.9rem; padding:11px; border-radius:11px; cursor:pointer; border:1px solid var(--bd2); background:linear-gradient(180deg,#141d2c,#0e1622); color:var(--tx); transition:.14s; }',
...
'.ktb .skmed .skm .nm{ font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:.64rem; color:#eef3fa; line-height:1.15; white-space:nowrap; }',   /* tên 1 hàng ĐỦ, không cắt/ellipsis (side 190px, font dư chỗ cho "Ngũ Hành Đại Chuyển") */
...
'.ktb .skmed.emed .skdisc .fb{ font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:18px; color:color-mix(in srgb,var(--a) 70%,#cbd5e1); }',
...
'.ktb .ltbox .lt-mk .fb{ font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:19px; color:#f3e2b0; }',
'.ktb .ltbox h1{ margin:0; font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:22px; letter-spacing:.6px; background:linear-gradient(180deg,#f7e2a8,#f5b942 56%,#c9932e); -webkit-background-clip:text; background-clip:text; color:transparent; }',
...
'.ktb .ltbox .mc .disc .g{ position:absolute; inset:0; display:grid; place-items:center; font-family:"Lora","Noto Serif SC",serif; font-weight:700; font-size:29px; color:color-mix(in srgb,var(--a) 60%,#5b6b82); }',
...
'.ktb .ltbox .l2-stp .no{ width:22px; height:22px; flex:none; border-radius:50%; display:grid; place-items:center; font-family:"Lora","Noto Serif SC",serif; font-size:12px; font-weight:700; color:#64748b; border:1px solid #33425c; }',
'.ktb .ltbox .l2-stp .v{ font-family:"Lora","Noto Serif SC",serif; font-size:14px; font-weight:600; color:#94a3b8; line-height:1.1; white-space:nowrap; }',
...
'.ktb .ltbox .l2-en .nm{ font-family:"Lora","Noto Serif SC",serif; font-size:14px; font-weight:700; color:#f2e2c4; }',
...
'.ktb .ltbox .l2-sech .t{ font-family:"Lora","Noto Serif SC",serif; font-size:15px; font-weight:700; color:#e8c877; letter-spacing:.4px; }',
...
'.ktb .ltbox .l2-ds .dnm{ font-family:"Lora","Noto Serif SC",serif; font-size:15px; font-weight:700; color:#f0f5fc; margin:1px 0 3px; }',
...
'.ktb .ltbox .l2-mini .s .n{ font-family:"Lora","Noto Serif SC",serif; font-size:13px; font-weight:700; color:#334157; }',
...
export function mountKtBattle(host, opts){
  ...
  function renderAll(){
    ...
    eIntent.className='intent eintent';
    /* CHỈ còn trạng thái Cháy. ĐÃ BỎ telegraph lối đánh của quái (đòn quái vốn hên xui, chỉ báo không giúp gì); boss đã có telegraph ở cột huy chương chiêu. */
    eIntent.textContent=((S.eBurn||0)>0?('燃 Cháy '+S.eBurn+' lượt'):'');
    renderEnemySkills();
