...
import { bangPhai, ensureBangPhai } from './bangphai.js';            // Bang Phái (thế lực giang hồ, cách ly)
...
window.bangPhai = bangPhai;           // expose component factory cho x-data trong view Bang Phái
